...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('jobListings', '0002_remove_job_company_remove_job_duration_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jobListings.job')),
            ],
        ),
    ]
